...
/**
 * @see https://lightning.engineering/api-docs/api/lnd/rest-endpoints
 */
class LightningService
{
    ...
    public function loadMacaroon($macaroonPath)
    {
        if (file_exists($macaroonPath)) {
            ...
            $this->macaroonHex = file_get_contents($macaroonPath);
        } else {
            throw new \Exception('Macaroon not found in ' . $macaroonPath);
        }
    }

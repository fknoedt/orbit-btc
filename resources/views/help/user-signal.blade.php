...
<div class="p-6 bg-gray-900 text-black-400 dark:text-gray-400 rounded-lg">
    <section>
        ...
        <p class="mt-2">
            Orbit BTC is your playground for crafting custom bitcoin analysis models. Mix and match <span
        ...
        <p class="mt-2">
            ...
            your model’s score hits its threshold. It then checks how it performs over your chosen time horizon (1 to 10
    ...
    <section class="pt-8">
        ...
        <ul class="list-disc pl-5 mt-2 space-y-2">
            <li><span class="font-bold">Name</span>: Pick a short, snappy name for your model—makes it easier to spot
                later.
            </li>
            <li><span class="font-bold">Description</span>: Jot down what your model’s all about and what it’s aiming
                for.
            </li>
            <li><span class="font-bold">Notify Email/Telegram</span>: Get a ping with your model’s daily signal (more on
                that below).
            </li>
        </ul>
        ...
        <ul class="list-disc pl-5 mt-2 space-y-2">
            ...
            <li><span class="font-bold">Metric Weight</span>: Give each metric a weight (0 to 10, 0.1 steps) to boost
                its impact. Daily change % × weight = that metric’s <span class="font-bold">Daily Signal</span>.
            </li>
            <li><span class="font-bold">Metric Threshold [optional]</span>: Set a minimum bar for the metric’s <span
                        class="font-bold">Daily Signal</span>. If it doesn’t hit this, it’s ignored that day.
            </li>
        </ul>
        <p class="mt-2 italic">Add up each metric’s <span class="font-bold">Daily Signal</span> to get the <span
                    class="font-bold">Model Daily Signal</span>.</p>
        ...
        <ul class="list-disc pl-5 mt-2 space-y-2">
            ...
            <li><span class="font-bold">Model Daily Threshold</span>: Set the magic number your <span class="font-bold">Model Daily Signal</span>
        ...
        <p class="mt-2 italic">All your <span class="font-bold">Model Daily Signals</span> add up to the <span
                    class="font-bold">Model Global Score</span>, updated daily.</p>
    </section>
    ...
    <section class="pt-8">
        <h2 class="text-xl font-semibold text-orange-500 border-orange-500 border-b-2 pb-2 mb-4">How Daily Scores
            Work</h2>
        <p class="mt-2">
            Here’s the deal: each day, Orbit checks how your metrics shift from the day before—like Total Volume up 5%
            or Fear & Greed down 2%. Multiply those changes by their weights (say, 5% × 2.0 = 10, -2% × 1.5 = -3), then
            add them up for your <span class="font-bold">Model Daily Signal</span> (10 + (-3) = 7). If that beats your
            <span class="font-bold">Model Daily Threshold</span> (like 7 > 5), it triggers a Buy or Sell, depending on
            your setup.
        </p>
    </section>
    ...
    <section class="pt-8">
        ...
        <div class="bg-gray-800 p-4 rounded mt-2">
            <p>
                You build a model: Total Volume (weight 2.0), Fear & Greed (weight 1.5), threshold 15, Sell signal,
                3-day horizon. One day, Total Volume jumps 8% (8 × 2.0 = 16), Fear & Greed nudges up 2% (2 × 1.5 = 3).
                Model Daily Signal = 19, beating 15, so it sells $1000 at $100,000. Three days later, price drops to
